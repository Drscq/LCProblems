...
## Examples
**Example 1:**
![alt text](/Figures/Meta/133%20Clone%20Graph/CloneGraphExample1.png)
...
- Space Complexity: O(N), for storing the cloned nodes in the hashmap and the recursion stack.